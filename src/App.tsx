...
export default function App() {
  ...
  const FAST_PRODUCTS: Product[] = [
    { id: 'k1', name: 'Benzolac 2,5%', price: 25000, img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/kecantikan/benzolac2.jpg', cat: 'kecantikan', isBest: true },
    { id: 'k2', name: 'Benzolac 5%', price: 31000, img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/kecantikan/BENZOLAC-5.jpg', cat: 'kecantikan', isBest: true },
    { id: 'k3', name: 'Benzolac CL', price: 49000, img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/kecantikan/benzolac-cl.jpg', cat: 'kecantikan', isPromo: true },
    { id: 'k6', name: 'Kloderma Gel', price: 33000, img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/kecantikan/KLODERMAgel.png', cat: 'kecantikan', isPromo: true },
    { id: 'k7', name: 'Mediklin Sol', price: 60900, img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/kecantikan/mediklinsol.jpg', cat: 'kecantikan', isPromo: true },
    { id: 'a1', name: 'Anakonidin OBH', price: 21000, img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/anak/anakonidin.jpg', cat: 'anak' },
    { id: 'a2', name: 'Bodrexin', price: 10000, img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/anak/bodrexin.png', cat: 'anak', isBest: true },
    { id: 'a6', name: 'Koolfever', price: 13000, img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/anak/koolfever.jpg', cat: 'anak', isBest: true },
    { id: 'd1', name: 'Actifed Merah', price: 70500, img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/dewasa/ACTIFED.jpg', cat: 'dewasa', isBest: true },
    { id: 'd2', name: 'Andalan FE', price: 35000, img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/dewasa/ANDALAN-FE.png', cat: 'dewasa' },
    { id: 'v1', name: 'Blackmores Bio C', price: 95000, img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/vitamin/blackmores-1.jpg', cat: 'vitamin', isBest: true },
    { id: 'v2', name: 'Blackmores Multivitamin', price: 165000, img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/vitamin/Blackmores-multivitamin.jpg', cat: 'vitamin' },
    { id: 'h5', name: 'Promag Herbal', price: 28000, img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/herbal/promag-herbal.jpg', cat: 'herbal', isBest: true },
    { id: 'h7', name: 'Tolak Angin', price: 32000, img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/herbal/tolak%20angin%20herbal.jpg', cat: 'herbal', isBest: true },
  ];

  const PROMO_BANNER_PRODUCTS = [
    { name: 'Niacef (Rp 57.000)', img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/promo/niacef.png' },
    { name: 'Vitacid (Rp 67.000)', img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/promo/vitacid.jpg' },
    { name: 'Vitacid Cream (Rp 52.500)', img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/promo/vitacidcrm.jpg' },
    { name: 'Kloderma Cream (Rp 63.500)', img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/promo/klodermacrm.jpg' },
    { name: 'Kloderma Oint (Rp 63.500)', img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/promo/klodermaoint.jpg' },
    { name: 'Mediklin (Rp 50.500)', img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/promo/MEDIKLIN.jpg' },
    { name: 'Ketomed SS (Rp 82.500)', img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/promo/KETOMEDSS.png' },
    { name: 'Carmed 20 (Rp 74.500)', img: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/promo/CARMED20.jpg' },
  ];

  const GALLERY_ITEMS = [
    { type: 'video', src: 'https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/galeri/1.mp4', title: 'Aktivitas Apotek Sehatku', desc: 'Pelayanan ramah & profesional apoteker berlisensi.' },
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm backdrop-blur-md bg-white/95">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-3.5 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => scrollToSection("home")}>
            <img src="https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/mitra.png" alt="Sehatku Logo" className="w-11 h-11 rounded-full object-cover border-2 border-emerald-500 shadow-md shadow-emerald-500/10" />
            <div>
        ...
        {showPromoPopup && (
          ...
          >
            ...
            >
              ...
              <img 
                src="https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/Promo.jpg" 
                alt="Promo Banner Sehatku Store" 
                className="w-full h-auto object-cover"
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  const fallbacks = [
                    "https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/promo.jpg",
                    "https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/Promo.png",
                    "https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/promo.png",
                    "https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/Promo.jpeg",
                    "https://raw.githubusercontent.com/parjojuminet-cpu/sehatku/main/promo.jpeg",
                    "https://placehold.co/400x500/10b981/ffffff?text=Promo+Spesial+Apotek"
                  ];
